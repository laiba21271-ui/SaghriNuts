/* =========================================================
   SAGHRI NUTS - STORE FUNCTIONALITY
   Cart is stored in localStorage so it works on GitHub Pages.
   ========================================================= */
...
function productFromCard(card) {
  ...
  // Wholesale cards have different prices/images, so detect them first.
